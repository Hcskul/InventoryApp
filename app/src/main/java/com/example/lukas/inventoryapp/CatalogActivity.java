...
public class CatalogActivity extends AppCompatActivity {
    ...
    private void displayDatabaseInfo() {
        ...
        try {
            ...
            // _id - name - price - quantity - supplier name - supplier number
            //
            // In the while loop below, iterate through the rows of the cursor and display
            // the information from each column in this order.
            displayView.setText("The entries table contains " + cursor.getCount() + " entries.\n\n");
            ...
            int quantityColoumnIndex = cursor.getColumnIndex(InventoryEntry.COLUMN_QUANTITY);
            int supplierNameColoumnIndex = cursor.getColumnIndex(InventoryEntry.COLUMN_SUPPLIER_NAME);
            int supplierNumberColoumnIndex = cursor.getColumnIndex(InventoryEntry.COLUM_SUPPLIER_NUMBER);
            ...
            while (cursor.moveToNext()) {
                ...
                int currentQuantity = cursor.getInt(quantityColoumnIndex);
                String currentSupplierName = cursor.getString(supplierNameColoumnIndex);
                String currentSupplierNumber = cursor.getString(supplierNumberColoumnIndex);
